...
def main():
    ...
    with open("corpus-uk-zh/corpus-uk-zh/separate_files_zh/texts_11.txt", "r", encoding="utf-8") as file:
        text = file.read()
...
#Загальна кількість іменникових фраз у сегменті корпусу: 3299